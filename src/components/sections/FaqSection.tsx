...
const FAQ: Record<string, QA[]> = {
  ...
  ru: [
    { q: 'Как заказать трансфер?', a: 'Отправьте запрос через форму или WhatsApp — мы быстро подтвердим цену и время подачи.' },
    { q: 'Сколько стоит трансфер Вена ⇄ Братислава?', a: 'Мы работаем по фиксированным ценам без скрытых сборов. Точную цену вы получите сразу по запросу.' },
    { q: 'Какие способы оплаты вы принимаете?', a: 'Наличные и банковская карта (EUR).' },
    { q: 'Сколько багажа можно взять?', a: 'Стандартный багаж на человека включён. О негабаритном (лыжи, велосипед) сообщите в запросе.' },
  ...
  uk: [
    { q: 'Як замовити трансфер?', a: 'Надішліть запит через форму або WhatsApp — ми швидко підтвердимо ціну та час подачі.' },
    { q: 'Скільки коштує трансфер Відень ⇄ Братислава?', a: 'Ми працюємо за фіксованими цінами без прихованих зборів. Точну ціну ви отримаєте одразу за запитом.' },
    { q: 'Які способи оплати ви приймаєте?', a: 'Готівка та банківська картка (EUR).' },
    { q: 'Скільки багажу можна взяти?', a: 'Стандартний багаж на особу включено. Про негабаритний (лижі, велосипед) повідомте в запиті.' },
