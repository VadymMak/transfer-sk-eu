...
const SK: AdminTranslations = {
  ...
  trips: {
    ...
    headlineLabel:         'Headline (H1)',
    headlinePlaceholder:   'Question headline with a keyword',
    audienceLabel:         'Who it\'s for',
    audiencePlaceholder:   'One item per line',
    itineraryPlaceholder:  'Each line: 03:30 — text',
    includedLabel:         'Included',
    includedPlaceholder:   'One item per line',
    extrasLabel:           'Paid extra',
    extrasPlaceholder:     'One item per line',
    bookingNoteLabel:      'Booking note',
    bookingNotePlaceholder:'e.g. 50 € deposit, booking by phone',
    tagsLabel:             'Tags',
    tagsPlaceholder:       'comma-separated',
    faqLabel:              'FAQ · Questions & answers',
    addFaqBtn:             '+ Add question',
    faqQuestionPlaceholder:'Question',
    faqAnswerPlaceholder:  'Answer',
    globalSettingsLabel:   'Global settings',
    priceAdultLabel:       'Price, adult (€) *',
    priceChildLabel:       'Price, child under 14 (€)',
    optional:              'optional',
    prepaymentLabel:       'Prepayment (€)',
    totalSeatsLabel:       'Total seats',
    bookingPhoneLabel:     'Booking phone / WhatsApp',
...
const RU: AdminTranslations = {
  ...
  trips: {
    ...
    headlineLabel:         'Заголовок H1',
    headlinePlaceholder:   'Заголовок-вопрос с ключевым словом',
    audienceLabel:         'Для кого поездка',
    audiencePlaceholder:   'Каждая строка — отдельный пункт',
    itineraryPlaceholder:  'Каждая строка: 03:30 — текст',
    includedLabel:         'Что входит в цену',
    includedPlaceholder:   'Каждая строка — отдельный пункт',
    extrasLabel:           'Доплачивается отдельно',
    extrasPlaceholder:     'Каждая строка — отдельный пункт',
    bookingNoteLabel:      'Примечание к брони',
    bookingNotePlaceholder:'Например: предоплата 50 €, запись по телефону',
    tagsLabel:             'Теги',
    tagsPlaceholder:       'через запятую',
    faqLabel:              'FAQ · Вопросы и ответы',
    addFaqBtn:             '+ Добавить вопрос',
    faqQuestionPlaceholder:'Вопрос',
    faqAnswerPlaceholder:  'Ответ',
    globalSettingsLabel:   'Глобальные настройки',
    priceAdultLabel:       'Цена, взрослый (€) *',
    priceChildLabel:       'Цена, ребёнок до 14 (€)',
    optional:              'необязательно',
    prepaymentLabel:       'Предоплата (€)',
    totalSeatsLabel:       'Всего мест',
    bookingPhoneLabel:     'Телефон / WhatsApp для брони',
